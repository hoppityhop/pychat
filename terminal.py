# Used for flow control of the client application, process forking
...
# Global variable to make sure each username gets a unique color
color_number = 3
...
def display_chat(main_screen, curses=curses):
    ...
    # We always want the chat window to start right above the input line
    ...
    for element in chat_record:
        ...
        # This is purely for colorization of the username, we split the
        # Username: Text in to tokens, colorize the name so that it's always the
...
# Helper function to append the name of the current user to the message they
# sent
